...
export declare function parseSong(platformName: keyof Platforms, url: string): Promise<SongParser>;
export declare function parseAlbum(platformName: keyof Platforms, url: string): Promise<AlbumParser>;
export declare function parseArtist(platformName: keyof Platforms, url: string): Promise<ArtistParser>;
export declare function parsePlaylist(platformName: keyof Platforms, url: string): Promise<PlaylistParser>;
export declare function parseSearch(platformName: keyof Platforms, query: string): Promise<SearchParser>;
